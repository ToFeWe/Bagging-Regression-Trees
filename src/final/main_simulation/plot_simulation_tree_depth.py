"""
The module which created Figure 7 of the final paper can be found under
*src.final.main_simulation.plot_simulation_tree_depth* and a figure with the same
